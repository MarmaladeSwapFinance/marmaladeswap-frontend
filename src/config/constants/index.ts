...
import { BUSD, DAI, USDT, BTCB, CAKE, WBNB, UST, ETH, USDC, MARM } from './tokens'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [BUSD[ChainId.MAINNET], MARM[ChainId.MAINNET], BTCB],
  [ChainId.TESTNET]: [WETH[ChainId.TESTNET], MARM[ChainId.TESTNET], BUSD[ChainId.TESTNET]],
}
